...
We now extend our set of observations to multiple wall colors rather than the single observation case of time. Our base system expands by including powers of all symbols. Note that in some environments, powers of a mixture of symbols may be the way to go. We leave the decision of choosing powers up to the user, as it is dependent on the choice of application.
